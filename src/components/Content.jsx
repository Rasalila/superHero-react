...
function Content() {
  return (
    <>
      ...
      <ListHero name="Железный человек"
      ...
      <ListHero name="Спайдер-мен/Человек-паук"
        universe="Marvel Comics"
